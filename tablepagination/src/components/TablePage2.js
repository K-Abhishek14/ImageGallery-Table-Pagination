...
class TablePage2 extends Component {
	...
	render() {
		...
		console.log("objectaaaaaaaaaaaaaaaaaaa", emp.map(a => console.log("BB",Object.values(a))));
		return (
			<Paper className={classes.root}>
				<Table>
					...
					<TableBody>
						{emp.slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage).map(a => Object.values(a).map(item => (
				...
				<TablePagination
					rowsPerPageOptions={[10, 20, 30, 40, 50, 100, 150, 200, 250, 300, 350, 400, 500]}
					component="div"
					count={emp.length}
...
export default TablePage2 = withStyles(styles, { withTheme: true })(TablePage2)
